...
import dataproviders.WomanClassDataProviderLoadDataFromCSV;
...
public class TestClassWomanViaCSV {

    @Test(dataProvider = "Constructor Method test data", dataProviderClass = WomanClassDataProviderLoadDataFromCSV.class)
    public void testClassConstructor(Woman woman) {
        Assert.assertNotNull(woman);
    }

    @Test(groups = "Getter",
            dataProvider = "Getter First Name test data", dataProviderClass = WomanClassDataProviderLoadDataFromCSV.class)
    public void testGetFirstName(Woman woman, String firstName) {
        Assert.assertEquals(woman.getFirstName(), firstName);
    }

    @Test(groups = "Setter",
            dataProvider = "Constructor Method test data", dataProviderClass = WomanClassDataProviderLoadDataFromCSV.class)
    ...
    @Test(groups = "Getter",
            dataProvider = "Getter Last Name test data", dataProviderClass = WomanClassDataProviderLoadDataFromCSV.class)
    ...
    @Test(groups = "Getter",
            dataProvider = "Getter Age test data", dataProviderClass = WomanClassDataProviderLoadDataFromCSV.class)
    ...
    @Test(groups = "Getter",
            dataProvider = "Getter Maiden Name test data", dataProviderClass = WomanClassDataProviderLoadDataFromCSV.class)
    ...
    @Test(dataProvider = "IsRetried test data", dataProviderClass = WomanClassDataProviderLoadDataFromCSV.class)
    public void testIsRetriedTrue(Woman woman, boolean isRetried) {
        Assert.assertEquals(woman.isRetired(), isRetried);
    }

    @Test(dataProvider = "RegisterPartnership", dataProviderClass = WomanClassDataProviderLoadDataFromCSV.class)
    ...
    @Test(dataProvider = "RegisterPartnershipTwoMarriage", dataProviderClass = WomanClassDataProviderLoadDataFromCSV.class)
    ...
    @Test(expectedExceptions = AlreadyMarriedException.class,
            dataProvider = "RegisterPartnershipShouldTrowException", dataProviderClass = WomanClassDataProviderLoadDataFromCSV.class)
    ...
    @Test(dataProvider = "DeregisterPartnership", dataProviderClass = WomanClassDataProviderLoadDataFromCSV.class)
